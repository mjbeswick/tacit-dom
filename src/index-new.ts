...
export { signal, computed, effect, batch, type Signal, type Computed } from './signals-new';

// Export the new DOM system
export { component, useSignal, div, button, h1, render, type Component } from './dom-new';
